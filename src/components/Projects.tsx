      ...
      <div className="container">
        ...
        >
          <div>
            ...
            >
              A collection of projects showcasing my focus on interaction,
              ...
              >
                <a
                  ...
                  style={{
                    ...
                    background:
                      hoveredIdx === idx
                        ? "linear-gradient(135deg, rgba(124,58,237,0.04) 0%, rgba(96,165,250,0.04) 100%)"
                        : "transparent",
                    borderRadius: "var(--radius)",
                    transition:
                      "background 0.4s ease-out, opacity 0.3s ease-out",
                    opacity:
                      hoveredIdx === null || hoveredIdx === idx ? 1 : 0.4,
                  }}
                >
                  <div style={{ flex: "1 1 min-content" }}>
                    ...
                    <h3
                      style={{
                        ...
                        color:
                          hoveredIdx === idx ? "var(--accent)" : "var(--text)",
                        position: "relative",
                        zIndex: 1,
                      }}
                    >
            ...
            >
              <div
                style={{
                  ...
                  height: "100%",
                  background:
                    "conic-gradient(from 0deg at 50% 50%, transparent 0deg, rgba(255,255,255,0.2) 90deg, transparent 360deg)",
                  borderRadius: "50%",
                  filter: "blur(30px)",
                  animation:
                    hoveredIdx !== null
                      ? "spinAnimation 4s linear infinite"
                      : "none",
                }}
              />
            </motion.div>
            ...
            {PROJECTS.map((project, idx) => (
              <motion.div
                ...
                animate={{
                  ...
                  rotateX:
                    hoveredIdx === idx ? rotation.x + velocity.y * 1.5 : 0,
                  rotateY:
                    hoveredIdx === idx ? rotation.y - velocity.x * 1.5 : 0,
                }}
                ...
                */}
                <div
                  style={{
                    ...
                    animation:
                      hoveredIdx === idx
                        ? "floatAnimation 3.5s ease-in-out infinite"
                        : "none",
                  }}
                >
                  <img
                  ...
                  <div
                    style={{
                      ...
                      animation:
                        hoveredIdx === idx
                          ? "sweepAnimation 2.5s ease-in-out infinite"
                          : "none",
                    }}
                  />
                </div>
              ...
              <>
                {[...Array(4)].map((_, i) => (
                  <motion.div
                    ...
                    animate={{
                      x:
                        Math.sin(i) * imageMouse.x * 0.25 +
                        velocity.x * (i + 1.2),
                      y:
                        Math.cos(i) * imageMouse.y * 0.25 +
                        velocity.y * (i + 1.2),
                    }}
                    transition={{
                      type: "spring",
