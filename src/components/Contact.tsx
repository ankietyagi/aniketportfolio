...
const links = [
  ...
  {
    label: "Phone",
    value: "+91 85270 70243",
    href: "tel:+918527070243",
    icon: (
      <svg
        width="18"
        height="18"
  ...
  },
  {
    label: "LinkedIn",
    value: "aniket-tyagi",
    href: "https://www.linkedin.com/in/aniket-tyagi-1243643a3/",
    icon: (
      <svg
        width="18"
        height="18"
  ...
  useEffect(() => {
    const ctx = gsap.context(
      () => {
        ...
        // Heading Reveal
        tl.fromTo(".anim-heading", { opacity: 0, y: 50, rotateX: -15 }, {
          opacity: 1,
          y: 0,
          rotateX: 0,
          duration: 1,
          ...
          >
            ...
            >
              <svg
                ...
                style={{
                  strokeDasharray: "100",
                  animation: "drawSVG 0.8s ease-out forwards",
                }}
              >
            ...
            >
              Your creative payload has been successfully delivered. I will
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            <a
              ...
              style={{
                ...
                color: "var(--bg)",
                boxShadow:
                  "0 15px 30px color-mix(in srgb, var(--accent) 30%, transparent)",
              }}
            >
              <div
                style={{
